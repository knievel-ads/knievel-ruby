  ...
  class DecisionsApi
    ...
    def decisions_with_http_info(project_id, decisions_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DecisionsApi.decisions ...'
      end
      # verify the required parameter 'project_id' is set
      if @api_client.config.client_side_validation && project_id.nil?
        fail ArgumentError, "Missing the required parameter 'project_id' when calling DecisionsApi.decisions"
      end
      # verify the required parameter 'decisions_request' is set
      if @api_client.config.client_side_validation && decisions_request.nil?
        fail ArgumentError, "Missing the required parameter 'decisions_request' when calling DecisionsApi.decisions"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"DecisionsApi.decisions",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DecisionsApi#decisions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
