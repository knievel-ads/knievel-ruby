...
# Unit tests for Knievel::ProjectResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Knievel::ProjectResponse do
  #let(:instance) { Knievel::ProjectResponse.new }

  describe 'test an instance of ProjectResponse' do
    it 'should create an instance of ProjectResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Knievel::ProjectResponse)
    end
  end
