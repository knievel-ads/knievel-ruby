...
# Unit tests for Knievel::Creative
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Knievel::Creative do
  #let(:instance) { Knievel::Creative.new }

  describe 'test an instance of Creative' do
    it 'should create an instance of Creative' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Knievel::Creative)
    end
  end
